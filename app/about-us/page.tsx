    ...
    <main>
      <section className="min-h-screen bg-[#fafcff] flex flex-col items-center pt-32 pb-16 overflow-hidden">
        ...
        <div className="text-center px-4 flex flex-col items-center z-10 w-full">
          <p className="text-slate-800 text-lg md:text-xl font-medium mb-2 md:mb-3">
            Celebrating 23 years of
          </p>
          <h1 className="text-4xl md:text-6xl lg:text-[5rem] font-extrabold text-red-900 tracking-tight leading-tight">
            ABC’s Academic & Competitive Excellence
          </h1>
          {/* Minimalist Blue Underline */}
          <div className="h-[3px] w-16 bg-red-600 mt-6" />
        </div>
