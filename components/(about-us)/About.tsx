    ...
    <main className="bg-slate-50 min-h-screen overflow-hidden">
      ...
      <section className="py-24 px-6">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 uppercase tracking-tighter">
            Honouring Our{" "}
            <span className="text-red-600 italic">Inspiration</span>
          </h1>
          ...
          {founders.map((founder, index) => (
            ...
            >
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-red-600 font-bold text-sm uppercase tracking-wide mb-4">
                  {founder.title}
                </p>
      ...
      <section className="py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="bg-red-900 rounded-[3.5rem] p-10 md:p-20 relative overflow-hidden shadow-2xl shadow-blue-900/20">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-slate-500 text-lg md:text-xl leading-relaxed font-medium">
              ...
              <span className="text-red-600 underline decoration-blue-200 underline-offset-4 ml-2">
        ...
        >
          ...
          <form className="space-y-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              className="w-full bg-red-600 text-white py-5 rounded-2xl font-bold text-lg shadow-xl shadow-blue-200 transition-all"
            >
              Send Message
            </motion.button>
          </form>
